...
import { Shield, Eye, EyeOff, TrendingUp, Camera, Video, Loader2, AlertCircle, CheckCircle2, Mail } from "lucide-react";
...
export default function SignUpPage() {
    ...
    const handleSignUp = async (e: React.FormEvent) => {
        ...
        const { error: authError, confirmEmail } = await signUp(email, password);

        if (authError) {
            if (authError.message.includes("already registered")) {
                setError("E-postadressen är redan registrerad. Prova att logga in istället.");
            } else {
                ...
                <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20 py-16">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                        ...
                        <h1 className="text-3xl xl:text-4xl font-extrabold tracking-tight leading-tight mb-4">
                            Kom igång<br />
                            <span className="text-gradient-gold">helt gratis.</span>
                        </h1>
                        <p className="text-muted-foreground text-base leading-relaxed mb-10 max-w-md">
                            Skapa ditt konto och få omedelbar tillgång till Nordens mest avancerade plattform för maskinvärdering.
                        </p>
                ...
                >
                    ...
                    {emailSent ? (
                        ...
                        >
                            ...
                            <h2 className="text-2xl font-extrabold tracking-tight mb-2">Bekräfta din e-post</h2>
                            ...
                            <div className="flex items-center gap-2 justify-center text-xs text-muted-foreground">
                                ...
                                <span>Kolla din inbox (och skräpposten)</span>
                            </div>
                            <div className="mt-8 pt-6 border-t border-border">
                                <p className="text-sm text-muted-foreground">
                                    Redan bekräftat?{" "}
                                    <Link to="/logga-in" className="text-primary font-bold hover:underline">
                                        Logga in
                                    </Link>
                                </p>
                            </div>
                        ...
                        /* Sign-up form */
                        <>
                            <h2 className="text-2xl font-extrabold tracking-tight mb-1">Skapa konto</h2>
                            <p className="text-sm text-muted-foreground mb-8">Komma igång – helt gratis, ingen kortuppgift krävs.</p>
